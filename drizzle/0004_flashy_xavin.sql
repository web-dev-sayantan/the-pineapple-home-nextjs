DROP TABLE `RatesToAvailability`;--> statement-breakpoint
/*
You're trying to delete PRIMARY KEY(availabilityId,roomId) from 'RoomsToAvailability' table
...
/*
You're trying to add PRIMARY KEY(availabilityId,rateId,roomId) to 'RoomsToAvailability' table
...
*/
--> statement-breakpoint
ALTER TABLE `RoomsToAvailability` ADD `rateId` text NOT NULL REFERENCES Rate(id);--> statement-breakpoint
/*
