...
export default async function Invoice() {
	...
	return (
		<>
			...
			<div className="flex flex-col w-full gap-4 p-8 md:flex-row md:flex-wrap">
				{invoices?.length ? (
					<>
						<Card className="flex flex-col justify-between w-full md:w-1/3">
						...
						{invoices.map((invoice) => (
							<Card
								className="flex flex-col justify-between w-full md:w-1/3"
								key={invoice.id}
							>
